...
public class Elevator extends Mechanism {
    ...
    private Elevator() {
        ...
        previousEncoderCount = elevatorTalon.getSelectedSensorPosition(1);
    ...
    public void updateElevatorQueue(int buttonPressed) {
    ...
    public boolean atTarget() {
        if(encoderHealthy) {
            return getEncDelta(elevatorPosition) <= Constants.ENC_THRESHOLD && getLidarDelta(elevatorPosition) <= Constants.LIDAR_THRESHOLD;
        } else {
    ...
    private boolean checkEncoderValueInRange(ElevatorPosition positionToCheck) {
        return elevatorTalon.getSelectedSensorPosition(0) >= positionToCheck.getTargetEncValue() - Constants.ENC_THRESHOLD && elevatorTalon.getSelectedSensorPosition(0) <= positionToCheck.getTargetEncValue();
    }
