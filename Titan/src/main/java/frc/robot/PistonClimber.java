...
public class PistonClimber extends Mechanism {
    ...
    private PistonClimber() {
        frontPistons = new DoubleSolenoid(Constants.CLIMBER_FRONT_PISTON_FORWARD_PORT, Constants.CLIMBER_FRONT_PISTON_REVERSE_PORT);
        rearPistons = new DoubleSolenoid(Constants.CLIMBER_REAR_PISTON_FORWARD_PORT, Constants.CLIMBER_REAR_PISTON_REVERSE_PORT);
    }
